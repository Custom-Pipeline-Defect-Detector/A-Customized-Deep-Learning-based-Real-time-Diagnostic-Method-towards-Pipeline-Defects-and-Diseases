...
def find_max_proportion_lists(all_content_dict,defect_img=None):
    ...
    for k, v in all_content_dict.items():
        ...
        if len(max_ZAW_list) != 0:
            attribute_list = export_attribute_formula(defect_type=4, defect_list=max_ZAW_list)
        ...
        if len(max_CJ_list) != 0:
            attribute_list = export_attribute_formula(defect_type=5, defect_list=max_CJ_list)
