...
from excel_export_job import delete_excel, get_files_dict, find_max_proportion_lists, tqdm, write_excel
...
'''
def run_yolov7_test(weights=r'YOLOv7/best.pt', source=r'D:\python\yolov5_flask-main\static\uploads\000001.jpg',
               imgsz=640,
               conf_thres=0.25, iou_thres=0.45, device='cpu', view_img=True, save_txt=True, save_conf=True,
               nosave=False, classes=None, agnostic_nms=False, augment=False, update=False, project= 'static/output', name='exp',
    ...
    for i in tqdm(all_content_dict, desc="生成新excel文件ing"):
        if len(files_max_BX_list) != 0:
            excel_path = write_excel(files_max_BX_list, save_dir)  # 目前excel_path只能获得一种缺陷的xls
        if len(files_max_PL_list) != 0:
            excel_path = write_excel(files_max_PL_list, save_dir)
        time.sleep(0.05)
    print("===============新excel文件生成完毕！=====================")